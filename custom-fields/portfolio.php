...
Container::make( 'post_meta', 'Portfolio Item' )->where( 'post_template', '=', 'Templates/PortfolioTemplate.php' )->add_tab( __( 'Header Section' ), array(
		...
		Field::make( 'complex', 'contentwrapper' )->add_fields( 'text_field', array(
				...
				Field::make( 'text', 'title' ),
				Field::make( 'complex', 'content' )->add_fields( array(
